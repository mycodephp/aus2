...
class course_edit_form extends moodleform {
    ...
    function definition() {
        ...
        //delivery time colum add
        $mform->addElement('text','delivery', 'Delivery Time','maxlength="100"  size="10"');
        $mform->addHelpButton('delivery', 'delivery');
        $mform->setType('delivery', PARAM_RAW);
        // if (!empty($course->id) and !has_capability('moodle/course:changeidnumber', $coursecontext)) {
           // $mform->hardFreeze('delivery');
            $mform->setConstants('delivery', $course->delivery);
       // }
       //end delivery time colum add
